...
internal class RabbitMQTriggerAttributeBindingProvider : ITriggerBindingProvider
{
    ...
    public Task<ITriggerBinding> TryCreateAsync(TriggerBindingProviderContext context)
    {
        ...
        return Task.FromResult<ITriggerBinding>(new RabbitMQTriggerBinding(service, queueName, disableAck, this.logger, parameter.ParameterType, this.options.Value.PrefetchCount));
    }
